 ...
 * @param <E>
 */
public class ListSequence<E extends IdentifiableCloneable> extends LinkedList<E> implements IdentifiableCollection<E>, Cloneable {
  ...
  @Override
    ...
    public ListSequence<E> clone() {
            ...
            this.stream().forEach(e -> copy.add((E) e.clone()));
            return copy;
    }
