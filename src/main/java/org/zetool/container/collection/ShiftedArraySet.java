...
/**
 * A shifted arrayset contains object that are identifiable, but that do not necessarily start at index 0. E.g., a
 * shifted array set can store all objects with ids 100 to 200, without using space 0 to 99.
 *
 * @param <E>
 *
...
//	}
    ...
    public boolean remove(E element) {
        return remove(element.id() - offset);
    }
